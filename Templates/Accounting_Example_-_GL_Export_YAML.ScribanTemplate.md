This Scriban template generates a complete General Ledger export in YAML format, suitable for financial reporting, audit trails, and accounting system imports.

# Accounting GL Export Example (YAML)
    ...
    JSON_QUERY('[
        {
            ...
            "transactions_json": "[
                ...
                {\"id\": \"TXN004\", \"date\": \"2025-10-15\", \"description\": \"Customer payment - Invoice INV-2025-0851\", \"reference\": \"DEP/048\", \"debit\": 3500.00, \"credit\": 0.00, \"cost_center\": \"1001\"}
            ]"
        },
        {
            "account_number": "2010",
            ...
            "transactions_json": "[
                ...
                {\"id\": \"TXN006\", \"date\": \"2025-10-08\", \"description\": \"Invoice received from supplier - ACME Ltd\", \"reference\": \"PO/1247\", \"debit\": 0.00, \"credit\": 3200.00, \"cost_center\": \"5020\"},
                {\"id\": \"TXN007\", \"date\": \"2025-10-20\", \"description\": \"Payment to vendor - TechSupply Inc\", \"reference\": \"CHK/7823\", \"debit\": 2500.00, \"credit\": 0.00, \"cost_center\": \"5020\"},
                {\"id\": \"TXN008\", \"date\": \"2025-10-22\", \"description\": \"Invoice received from supplier - ProTools Ltd\", \"reference\": \"PO/1251\", \"debit\": 0.00, \"credit\": 2300.00, \"cost_center\": \"5025\"}
            ]"
        },
        {
            "account_number": "3010",
            ...
            "transactions_json": "[
                {\"id\": \"TXN009\", \"date\": \"2025-01-01\", \"description\": \"Opening balance\", \"reference\": \"OPEN/001\", \"debit\": 0.00, \"credit\": 50000.00, \"cost_center\": \"0000\"}
            ]"
        }
    ]') AS accounts_json;
```

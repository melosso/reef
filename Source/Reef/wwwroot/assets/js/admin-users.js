...
async function loadUsers() {
    try {
        ...
        tbody.innerHTML = users.map(user => {
            ...
            const deleteButtonClass = isFirstUser 
            ...
            <tr>
                ...
                <td class="px-6 py-4 text-sm text-right">
                    ...
                    <button onclick="deleteUser(${user.id}, '${user.username}')" class="${deleteButtonClass}" ${deleteButtonDisabled} ${isFirstUser ? 'title="Cannot delete the first user"' : ''}>

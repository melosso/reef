...
// Source: /Templates/Email_-_System_Error_Daily_Digest.ScribanTemplate.html (reference copy retained on disk; this is the seed copied into a QueryTemplates row at step-execution time)
namespace Reef.Core.Recipes;

internal static class ErrorDigestEmailTemplate
{
    public const string DailyDigestHtml = """""""""""""""
{{~ for row in rows ~}}
<!doctype html>
<html lang="en">
<head>

...
// Source: /Templates/Exact_Globe_-_eExact_XML_for_Debtors.ScribanTemplate.xml and
// /Templates/Exact_Globe_-_eExact_XML_for_Items.ScribanTemplate.xml (reference copies retained
// on disk; these are the seed copies copied into QueryTemplates rows at step-execution time).
namespace Reef.Core.Recipes;

internal static class ExactGlobeTemplates
{
    public const string DebtorsXmlTemplate = """""""""""""""
<?xml version="1.0" ?>
...
""""""""""""""";
    ...
    public const string ItemsXmlTemplate = """""""""""""""
<?xml version="1.0" ?>
<eExact xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="eExact-Schema.xsd">
  <Timestamp>{{ date.now | date.to_string '%Y-%m-%d.%H:%M' }}</Timestamp>
